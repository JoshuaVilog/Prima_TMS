...
<html lang="en">
	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
                                        ...
                                        <div class="widget-main">
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="txtSearchMoldCtrl" class="form-control input-lg disabled" placeholder="Enter / Scan Mold Control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div id="containerUpdateStatus" style="display:none">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control input-lg" id="txtPRNo">
                                                </div>
                                                <input type="hidden" id="hiddenRequestID">
                                                <div class="row center">
                                                    <button id="btnUpdateRequest" class="btn btn-success">SAVE</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
            ...
            // include "../getCodes/modal/modalEditReport.php";
