                                        ...
                                        <div class="widget-main">
                                            ...
                                            <div id="containerUpdateStatus" style="display:none">
                                                ...
                                                <div class="row center">
                                                    <button id="btnUpdateStatusGood" class="btn btn-success btn-sm">GOOD</button>
                                                    <button id="btnUpdateStatusNG" class="btn btn-danger btn-sm">NOT GOOD</button>
                                                    <button id="btnUpdateStatusCancel" class="btn btn-warning btn-sm">CANCEL REQUEST</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
